...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PRECONDITION = 17,              /* PRECONDITION  */
  YYSYMBOL_POSTCONDITION = 18,             /* POSTCONDITION  */
  YYSYMBOL_TYPE_STRING = 19,               /* TYPE_STRING  */
  YYSYMBOL_TYPE_INT = 20,                  /* TYPE_INT  */
  YYSYMBOL_TYPE_BOOL = 21,                 /* TYPE_BOOL  */
  YYSYMBOL_TYPE_VOID = 22,                 /* TYPE_VOID  */
  YYSYMBOL_TYPE_MAP = 23,                  /* TYPE_MAP  */
  YYSYMBOL_NIL = 24,                       /* NIL  */
  YYSYMBOL_OK = 25,                        /* OK  */
  YYSYMBOL_YYACCEPT = 26,                  /* $accept  */
  YYSYMBOL_program = 27,                   /* program  */
  YYSYMBOL_declarations = 28,              /* declarations  */
  YYSYMBOL_global_decl = 29,               /* global_decl  */
  YYSYMBOL_func_decl = 30,                 /* func_decl  */
  YYSYMBOL_type_list = 31,                 /* type_list  */
  YYSYMBOL_type_expr = 32,                 /* type_expr  */
  YYSYMBOL_api_block = 33,                 /* api_block  */
  YYSYMBOL_api_name = 34                   /* api_name  */
};
...
{
       0,    68,    68,    76,    79,    82,    85,    89,    96,   114,
     118,   125,   126,   127,   128,   129,   134,   140
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STRING_LITERAL", "NUMBER", "COLON", "ARROW", "SEMICOLON", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", "COMMA", "EQUALS",
  "PRECONDITION", "POSTCONDITION", "TYPE_STRING", "TYPE_INT", "TYPE_BOOL",
  "TYPE_VOID", "TYPE_MAP", "NIL", "OK", "$accept", "program",
  "declarations", "global_decl", "func_decl", "type_list", "type_expr",
  "api_block", "api_name", YY_NULLPTR
};
...
{
     -20,     5,     3,   -20,     1,     0,     2,   -20,   -20,   -19,
     -20,   -20,   -20,   -20,   -20,   -20,   -20,     4,     6,   -19,
     -20
};
...
{
       6,     0,     2,     1,     0,     0,     0,     5,    16,    17,
       3,     4,    11,    12,    13,    14,    15,     8,     7,     0,
      10
};
...
{
      12,    13,    14,    15,    16,     3,     4,     9,    10,    20,
      11,    19,     0,    -9
};

static const yytype_int8 yycheck[] =
{
      19,    20,    21,    22,    23,     0,     3,     6,     8,    19,
       8,     7,    -1,     7
};
...
{
       0,    27,    28,     0,     3,    29,    30,    33,    34,     6,
       8,     8,    19,    20,    21,    22,    23,    31,    32,     7,
      32
};
...
#line 79 "parser.yy"
                                       {
        functions.push_back(std::unique_ptr<FuncDecl>((yyvsp[-1].funcDecl)));
    }
#line 1409 "parser.tab.cc"
    break;

  case 5: /* declarations: declarations api_block  */
#line 82 "parser.yy"
                             {
...
#line 1423 "parser.tab.cc"
  ...
  case 7: /* global_decl: IDENTIFIER COLON type_expr  */
#line 89 "parser.yy"
                               {
...
#line 1432 "parser.tab.cc"
  ...
  case 8: /* func_decl: IDENTIFIER COLON type_list  */
#line 96 "parser.yy"
                               {
        ...
        if (!(yyvsp[0].typeList)->empty()) {
            returnTypes.push_back(std::move((yyvsp[0].typeList)->back()));
            (yyvsp[0].typeList)->pop_back();
        }
        
        (yyval.funcDecl) = new FuncDecl(*(yyvsp[-2].stringVal), std::move(*(yyvsp[0].typeList)), 
...
#line 1461 "parser.tab.cc"
  ...
  case 10: /* type_list: type_list ARROW type_expr  */
#line 118 "parser.yy"
                                {
